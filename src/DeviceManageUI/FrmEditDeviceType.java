...
public class FrmEditDeviceType extends JDialog implements ActionListener {
	...
	private JLabel labelName = new JLabel("修改为");
	...
	public FrmEditDeviceType(JFrame f, String s, boolean b) throws SQLException {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnCancel)
			...
			try {
				this.setVisible(false);
				new DeviceTypeManager().EditDeviceType(DTName, DType);
